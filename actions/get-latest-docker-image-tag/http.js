...
export async function requestWithTimeout(url, opts = {}, timeoutMs = 10000) {
...
export async function fetchText(url, opts = {}, attempts = 3, timeoutMs = 10000) {
    let lastErr = null;
...
export async function fetchJson(url, opts = {}, attempts = 3, timeoutMs = 10000) {
